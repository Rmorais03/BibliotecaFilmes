...
- Implements core concepts learned in the course, including:
  - Basic input/output operations
  - Conditional statements
  - Loops
  - Functions and modular code design
- Fully commented code to improve readability and maintainability.

## Requirements
- **.NET 6.0 SDK** (or later)
- Compatible with Windows, Linux, and macOS with .NET runtime installed.
